...
import { DocterComponent, CheckPatient } from './users/docter/docter.component';
...
@NgModule({
  ...
  entryComponents: [LoginDialog, SignupDialog, LoginDialogInBox, SignupDialogInBox, BookingDialog, ViewMoreDialog, CheckPatient]
})
